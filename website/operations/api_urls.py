...
urlpatterns = [
    ...
    path("v1/estimates/<uuid:pk>/external-status/", construction_api.api_v1_estimate_external_status, name="estimate-external-status"),
    ...
    path("v1/payment-schedules/<uuid:pk>/external-status/", construction_api.api_v1_payment_schedule_external_status, name="payment-schedule-external-status"),
    ...
    path("v1/projects/<uuid:pk>/commitments/", construction_api.api_v1_project_commitments, name="project-commitments"),
    path("v1/commitments/<uuid:pk>/status/", construction_api.api_v1_commitment_status, name="commitment-status"),
    path("v1/milestones/<uuid:pk>/status/", construction_api.api_v1_milestone_status, name="milestone-status"),
    path("v1/material-requests/<uuid:pk>/status/", construction_api.api_v1_material_request_status, name="material-request-status"),
    ...
    path("v1/native-upload-grants/", api.api_v1_native_upload_grant, name="native-upload-grant"),
    path("v1/native-upload/", api.api_v1_native_upload_complete, name="native-upload-complete"),
